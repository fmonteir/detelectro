...
int main(int argc, char **argv)
{
    ...
    int totalMCSweeps = atof(argv[5]);  //  number of sweeps
    int W = atof(argv[6]);  //  number of warm-up sweeps
    int A = atof(argv[7]);  //  number of auto-correlation sweeps
