...
int main(int argc, char **argv)
{
    ...
    double Bfield = atof(argv[4]);  //  chemical potential
    ...
    if (geom == 14)
    {
        ...
        double params[] = {1.046, 2.104, -0.184, 0.401, 0.507, 0.218, 0.338, 0.057};
        K.setParamsThreeOrbitalTB(params);
        double Delta = 0.1 / fabs(params[2]);
    ...
    OneParticlePropagators< NSITES, L > * Bdown=
      new OneParticlePropagators< NSITES, L >;
    Bup->fillMatrices( true, nu, h->matrix(), K.BpreFactor(dt, mu, 1, Bfield) );
    Bdown->fillMatrices( false, nu, h->matrix(), K.BpreFactor(dt, mu, -1, Bfield) );
                            ...
                            for (int x2 = 0; x2 < NX; x2++)
                                for (int y2 = 0; y2 < NY; y2++)
                                {
                                    if ( NORB * ( NX * y1 + x1 ) + a == NORB * ( NX * y2 + x2 ) + b )
                                    {
                                        ...
                                        NORB * ( NX * y2 + x2 ) + b) - Gdown->get(NORB * ( NX * y1 + x1 ) + a ,
                                        NORB * ( NX * y2 + x2 ) + b) + Gup->get(NORB * ( NX * y1 + x1 ) + a ,
                                        NORB * ( NX * y2 + x2 ) + b)
                                    ...
                                    else
                                    {
                                        ...
                                        NORB * ( NX * y2 + x2 ) + b)
                                          ...
                                          NORB * ( NX * y1 + x1 ) + a) + Gdown->get(NORB * ( NX * y2 + x2 ) + b,
                                          NORB * ( NX * y1 + x1 ) + a) ) * t * K.get(NORB * ( NX * y1 + x1 ) + a ,
                                          NORB * ( NX * y2 + x2 ) + b);

                                        magCorrZZ( NORB * y1 + a ,
                                        NORB * ( NX * y2 + abs(x2 - x1) ) + b ) +=
                                        ( - ( 1 - Gup->get(NORB * ( NX * y1 + x1 ) + a, NORB * ( NX * y1 + x1 ) + a) )
                                        * ( 1 - Gdown->get(NORB * ( NX * y2 + x2 ) + b, NORB * ( NX * y2 + x2 ) + b) )
                                        - ( 1 - Gdown->get(NORB * ( NX * y1 + x1 ) + a, NORB * ( NX * y1 + x1 ) + a) )
                                        * ( 1 - Gup->get(NORB * ( NX * y2 + x2 ) + b, NORB * ( NX * y2 + x2 ) + b) )
                                        + ( 1 - Gup->get(NORB * ( NX * y1 + x1 ) + a, NORB * ( NX * y1 + x1 ) + a) )
                                        * ( 1 - Gup->get(NORB * ( NX * y2 + x2 ) + b, NORB * ( NX * y2 + x2 ) + b) )
                                        + ( 1 - Gdown->get(NORB * ( NX * y1 + x1 ) + a, NORB * ( NX * y1 + x1 ) + a) )
                                        * ( 1 - Gdown->get(NORB * ( NX * y2 + x2 ) + b, NORB * ( NX * y2 + x2 ) + b) )
